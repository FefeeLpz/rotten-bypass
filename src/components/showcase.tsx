  ...
  return (
    <div id="inicio" className="flex flex-col mt-11">
       <h1 className="flex justify-center items-center text-white font-bold text-5xl mt-11 max-[500px]:flex-col">
        ...
        <h2 className="text-white font-normal text-lg mt-11">
            Buscas un bypass altamente efectivo y completamente automatizado? Permíteme presentarte la nueva versión del Rotten con su source y métodos 100% actualizada, brindándoles una buena seguridad al momento de cualquier pc check.
        </h2>
        <div id="showcase" className="text-center mt-11">
            <Link className=""  href="https://www.youtube.com/watch?v=V34YpRvDOFA" target="_blank">
