...
const ButtonRotatingBackgroundGradient = () => {
    return (
      <button className=' max-[650px]:mt-8 relative inline-flex h-10 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50'>
