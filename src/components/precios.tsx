    ...
    <div className="mt-32 flex max-[1150px]:flex-col  max-[1150px]:items-center ">
      <div className="flex flex-col">
        <div className="flex items-center">
          <h2 className="text-white text-4xl font-bold">
            <span className="text-purple-400">Rotten</span> Bypass
          </h2>
        </div>
        <div className="flex items-center">
         <ShieldCheck size={20} color="#42f04e" />
          <h2 className="text-green-700 ml-1 mt-2">
            Undetected
          </h2> 
        </div>
        <p className="text-white text-sm mt-2">
        Buscas un bypass altamente efectivo y completamente automatizado? <br></br>Permíteme presentarte la nueva versión del Rotten con su source y<br></br> métodos 100% actualizada, brindándoles una buena seguridad<br></br> al momento de cualquier pc check.
        </p>
        <div className="mt-3 flex flex-col justify-center">
          <div className="flex">
            <button type="button" className="max-[420px]:text-xs text-white hover:bg-violet-600 bg-black focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
            <h2>
              45 USD
            </h2>
            <h2>
          ...
          <Link href="https://discord.gg/YRnxDV2WxF" target="_blank" className="ml-20">
            <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full bg-violet-600 px-6 font-medium text-neutral-200"><span>
              Buy Now
      ...
      <div className="ml-44 flex flex-col justify-center items-center max-[1150px]:ml-0">
        ...
        <div className="text-white text-sm flex">
          ...
          Supported <span className="text-purple-400">OS:</span>
          </h2>
          <h2 className="text-white">
            Windows 10, KernelOS
          </h2>
          ...
          <h2 className="ml-4">
            Support <span className="text-purple-400">24/7</span>
          </h2>
        </div>
